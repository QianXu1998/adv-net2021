...
- [Is it allowed to generate additional traffic for the flows that must be way-pointed?](#is-it-allowed-to-generate-additional-traffic-for-the-flows-that-must-be-way-pointed)
- [Why do UDP flows seem to randomly loose a few packets?](#why-do-udp-flows-seem-to-randomly-loose-a-few-packets)
...
- [How to understand the output of `./cli.py experiment-performance [output-dir]`](#how-to-understand-the-output-of-clipy-experiment-performance-output-dir)
...
## Is it allowed to generate additional traffic for the flows that must be way-pointed?

Yes.

## Why do UDP flows seem to randomly loose a few packets?
...
This is only for waypointing; the other SLA types are not impacted. 
